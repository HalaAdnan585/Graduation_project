                                    ...
                                    <table class="table table-bordered" id="myTable" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="date" class="text-center" name="id" value="<?php echo e($id->id  ?? ''); ?>"></td>
                                              
                                            </tr>

                                            <tr>
                                                <th scope="row" class="text-center">رام الله والبيره</th>
                                                <td><input type="date" class="text-center" name="nationality" value="<?php echo e($ff->nationality ?? ''); ?>"></td>
                                                <td><input type="date" class="text-center" name="id" value="<?php echo e($id->id  ?? ''); ?>"></td>
...
</html><?php /**PATH C:\Users\HP\Downloads\Final_STATISTICS_PALESTINE-main\resources\views/dateTable.blade.php ENDPATH**/ ?>