...
<script>
    ...
    const markup=`<tr>
    <th scope="row">1</th>
    <td><input type="text" class="" name="FullName" id="FullName" value="<?php echo e($id->name ?? ''); ?>" data-toggle="tooltip" data-placement="bottom" title="ادخل الاسم الرباعي"></td>
    <td><input type="number" oninput="checkAge(event)" class="" name="age" id="age" value="<?php echo e($ff->age ?? ''); ?>"></td>
    ...
    <td><input type="text" class="" name="nationality" value="<?php echo e($ff->nationality ?? ''); ?>"></td>
    <td><input type="number" class="" name="id" value="<?php echo e($id->id  ?? ''); ?>"></td>
    <td><input type="text" class="" name="placeOfMotherTimeInvidualBirth" value="<?php echo e($ff->placeOfMotherTimeInvidualBirth ?? ''); ?>"></td>
    <td><input type="text" class="" name="place" value="<?php echo e($id->place  ?? ''); ?>"></td>
    ...
    <td><input type="text" class="" name="previous_place" value="<?php echo e($ff->previous_place ?? ''); ?>"></td>
                                    ...
                                    <table class="table table-bordered" id="myTable" style="overflow-x: scroll !important;min-width:300% !important;" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="" name="placeOfMotherTimeInvidualBirth" value="<?php echo e($ff->placeOfMotherTimeInvidualBirth ?? ''); ?>"></td>
                                                <td><input type="text" class="" name="citizin_place" value="<?php echo e($id->place  ?? ''); ?>"></td>
                                                <td><input type="number" class="" name="periodAt_theCurrent_residenceIn_fullTime" value="<?php echo e($ff->periodAt_theCurrent_residenceIn_fullTime ?? ''); ?>"></td>
                                                <td><input type="text" class="" name="previous_place" value="<?php echo e($ff->previous_place ?? ''); ?>"></td>
...
<?php echo $__env->make('template.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH M:\Final_STATISTICS_PALESTINE-main\resources\views/citizen.blade.php ENDPATH**/ ?>