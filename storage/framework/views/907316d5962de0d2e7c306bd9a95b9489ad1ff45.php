...
<body class="light rtl">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo e(url('/gropTable')); ?>">gropTable</a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('/exportedTable')); ?>">Export Table</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                            <a href="<?php echo e(url('/charts1')); ?>">charts1</a>
                               
                            </li>
                            <li>
                                <a href="<?php echo e(url('/charts2')); ?>">chart2</a>
                            </li>

                            <li>
                                <a href="<?php echo e(url('/floatChart')); ?>">float chart</a>
                            </li>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title">الافراد الغير مسجلين</h4>
                            </li>
    ...
    <script src="<?php echo e(asset('assets/js/bundles/export-tables/dataTables.buttons.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bundles/export-tables/buttons.flash.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bundles/export-tables/jszip.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bundles/export-tables/pdfmake.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bundles/export-tables/vfs_fonts.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bundles/export-tables/buttons.html5.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bundles/export-tables/buttons.print.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/pages/tables/jquery-datatable.js')); ?>"></script>
</body>



</html><?php /**PATH C:\Users\HP\Downloads\Final_STATISTICS_PALESTINE-main\resources\views/exportedTable.blade.php ENDPATH**/ ?>